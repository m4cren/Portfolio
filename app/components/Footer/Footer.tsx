...
const Footer = () => {
   ...
   return (
      <motion.footer
         ...
         className="fixed pointer-events-none opacity-60! bottom-0 left-0 right-0 h-[7rem] md:h-[9rem] flex flex-col md:flex-row justify-end md:justify-between px-2 md:px-12 items-center md:items-end pb-4 "
      >
         <div className="hidden lg:block ">
            ...
            <p className="text-sm!">
               The 3D environment is inspired by the interior design of my
               bedroom.
            </p>
         </div>
         <ul className="flex flex-row items-end justify-between w-full pb-3 px-1 min-[350px]:px-6 md:hidden">
